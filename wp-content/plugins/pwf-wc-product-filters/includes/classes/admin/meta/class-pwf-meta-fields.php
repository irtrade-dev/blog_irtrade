		...
		private function meta_fields() {
			...
			$fields = array(
				array(
					'type'       => 'text',
					'param_name' => 'title',
					'panel'      => array( 'checkboxlist', 'radiolist', 'dropdownlist', 'priceslider', 'button', 'rating' ),
					'group'      => 'general',
				...
				array(
					'type'        => 'text',
					'param_name'  => 'url_key',
					'panel'       => array( 'checkboxlist', 'radiolist', 'dropdownlist', 'priceslider', 'rating' ),
					'group'       => 'general',
				...
				array(
					...
					'panel'       => array( 'checkboxlist', 'radiolist', 'dropdownlist' ),
					'group'       => 'general',
				...
				array(
					...
					'panel'       => array( 'checkboxlist', 'radiolist', 'textlist', 'dropdownlist' ),
					'group'       => 'general',
				...
				array(
					...
					'panel'      => array( 'checkboxlist', 'radiolist', 'dropdownlist', 'rating' ),
					'group'      => 'general',
				...
				array(
					...
					'panel'      => array( 'checkboxlist', 'radiolist' ),
					'group'      => 'visual',
				...
				array(
					...
					'panel'      => array( 'checkboxlist', 'radiolist', 'dropdownlist', 'rating', 'priceslider' ),
					'group'      => 'visual',

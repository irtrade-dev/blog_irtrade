...
<div class="subsubsub_section <?php echo esc_attr($this->show_notes ? "woof_free" : "") ?>">
    ...
    <section class="woof-section">
        ...
        <div class="woof-header">
            <div>
                <h3 class="woof_plugin_name"><?php esc_html_e('WOOF - WooCommerce Products Filter Professional', 'woocommerce-products-filter') ?>&nbsp;<span class="woof__text-success">v.<?php echo esc_attr(WOOF_VERSION) ?></span>&nbsp;<span id="woof-head"><svg><use xlink:href="#svg-woof"></use></svg></span></h3>

<?php
/*
  Plugin Name: WOOF - Products Filter for WooCommerce Professional
  Plugin URI: https://products-filter.com/
  Description: WOOF - WooCommerce Products Filter Professional. Flexible, easy and robust products filter for WooCommerce store site!

                        ...
                        while ( $recent_posts->have_posts() ): $recent_posts->the_post();
                            ...
                            $post_loop .= '<'.$attr['contentTag'].' class="ultp-block-item post-id-'.$post_id.'">';
                                ...
                                $post_loop .= '<div class="ultp-block-content-wrap">';
                                    if ( $attr['showImage'] && ($idx == 0 || ($attr['layout'] == 'layout2') || ($attr['layout'] == 'layout3') || ($attr['layout'] == 'layout5') )) {
                                            ...
                                            if ($idx == 0) {
                                                $post_loop .= '<a href="'.$titlelink.'" '.($attr['openInTab'] ? 'target="_blank"' : '').'>';
                                                    if(has_post_thumbnail()){
                                                        $post_loop .= ultimate_post()->get_image($post_thumb_id, $attr['imgCrop'], '', $title, $attr['imgSrcset'], $attr['imgLazy']);
                                                    } else {
                                                        $post_loop .= '<img src="'.ULTP_URL."assets/img/ultp-placeholder.jpg".'"  />';
                                                    }
                                                $post_loop .= '</a>';
                                            } else {
                                                if ( has_post_thumbnail() && ($attr['layout'] == 'layout2') || ($attr['layout'] === 'layout3') || ($attr['layout'] === 'layout5')) {
                                                    $post_loop .= '<a href="'.$titlelink.'" '.($attr['openInTab'] ? 'target="_blank"' : '').'>'.ultimate_post()->get_image($post_thumb_id, $attr['imgCropSmall'], '', $title, $attr['imgSrcset'], $attr['imgLazy']).'</a>';
                                                }
                                            }
